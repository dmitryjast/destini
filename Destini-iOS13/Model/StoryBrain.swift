...
struct StoryBrain {
    ...
    let storiesArray = [
        ...
        //3
        Story(title: "What? Such a cop-out! Did you know accidental traffic accidents are the second leading cause of accidental death for most adult age groups?", choice1: "Yes", choice2: "No"),
        //4
        Story(title: "As you smash through the guardrail and careen towards the jagged rocks below you reflect on the dubious wisdom of stabbing someone while they are driving a car you are in.", choice1: "Yes", choice2: "No"),
        //5
        Story(title: "You bond with the murderer while crooning verses of - Can you feel the love tonight. He drops you off at the next town. Before you go he asks you if you know any good places to dump bodies. You reply: Try the pier.", choice1: "Yes", choice2: "No")
    ]
